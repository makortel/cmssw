#ifndef RecoSelectors_RecoTrackViewRefSelector_h
#define RecoSelectors_RecoTrackViewRefSelector_h
...
class RecoTrackViewRefSelector : public RecoTrackSelector {
 ...
 typedef edm::View<reco::Track> collection;
  ...
  RecoTrackViewRefSelector ( const edm::ParameterSet & cfg ) : RecoTrackSelector(cfg) {}
  
  RecoTrackViewRefSelector ( double ptMin, double minRapidity, double maxRapidity,
