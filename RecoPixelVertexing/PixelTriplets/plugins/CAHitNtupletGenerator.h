#ifndef RecoPixelVertexing_PixelTriplets_CAHitNtupletGenerator_h
#define RecoPixelVertexing_PixelTriplets_CAHitNtupletGenerator_h
...
public:
    ...
    ~CAHitNtupletGenerator() = default;

    static void fillDescriptions(edm::ParameterSetDescription& desc);
    static const char *fillDescriptionsLabel() { return "caHitNtuplet"; }
    ...
    public:
        ...
        enabled_(pset.getParameter<bool>("enabled")) {
            if (enabled_ && pt1_ >= pt2_)
                throw cms::Exception("Configuration") << "PixelNtupletGenerator::QuantityDependsPt: pt1 (" << pt1_ << ") needs to be smaller than pt2 (" << pt2_ << ")";
            if (pt1_ <= 0)
                throw cms::Exception("Configuration") << "PixelNtupletGenerator::QuantityDependsPt: pt1 needs to be > 0; is " << pt1_;
            if (pt2_ <= 0)
                throw cms::Exception("Configuration") << "PixelNtupletGenerator::QuantityDependsPt: pt2 needs to be > 0; is " << pt2_;
        }
