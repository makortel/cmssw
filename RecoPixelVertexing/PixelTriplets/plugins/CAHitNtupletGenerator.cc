...
constexpr unsigned int CAHitNtupletGenerator::minLayers;

CAHitNtupletGenerator::CAHitNtupletGenerator(const edm::ParameterSet& cfg, edm::ConsumesCollector& iC) :
...
void CAHitNtupletGenerator::fillDescriptions(edm::ParameterSetDescription& desc) {
...
void CAHitNtupletGenerator::initEvent(const edm::Event& ev, const edm::EventSetup& es) {
...
void CAHitNtupletGenerator::hitNtuplets(const IntermediateHitDoublets& regionDoublets,
