...
namespace {
  ...
  void fillNtuplets(const T1& regionLayerPairs,
                    const edm::EventSetup& iSetup,
                    const T2& seedingLayerHits,
                    const CAHitTripletGenerator& generator_,
                    T3& seedingHitSetsFiller) {
    generator_.hitTriplets(regionLayerPai
