...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  public:
    ...
    void produce(edm::StreamID, DeviceEvent& iEvent, DeviceEventSetup const& iSetup) const override {
  ...
  private:
    const ESDeviceGetToken<AlpakaESTestDataA, AlpakaESTestRecordA> esToken_;
