...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  private:
    ...
    ESDeviceGetToken<cms::alpakatest::AlpakaESTestDataB<Device>, AlpakaESTestRecordB> esToken_;
    EDDevicePutToken<portabletest::TestDeviceCollection> devicePutToken_;
    const int32_t size_;
