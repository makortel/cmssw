...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
   ...
   */
  class TestAlpakaGlobalProducerConsumeE : public global::EDProducer<> {
  public:
    TestAlpakaGlobalProducerConsumeE(edm::ParameterSet const& config)
        : esToken_(esConsumes()),
  ...
  private:
    const device::ESGetToken<AlpakaESTestDataEDevice, AlpakaESTestRecordE> esToken_;
...
DEFINE_FWK_ALPAKA_MODULE(TestAlpakaGlobalProducerConsumeE);
