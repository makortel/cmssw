...
namespace ALPAKA_ACCELERATOR_NAMESPACE::detail {
  Device const& chooseDevice(edm::StreamID id) {
    ...
    // TODO: limiting to first device for now because the EventSetup
    // side is currently limited to that. This limitation will be
    // improved in the future.
    return cms::alpakatools::devices<Platform>().at(0);
  }
}  // namespace ALPAKA_ACCELERATOR_NAMESPACE::detail
