...
public:
  ...
  void acquire(edm::StreamID id, const edm::Event& iEvent, const edm::EventSetup& iSetup, edm::WaitingTaskWithArenaHolder) const override;
...
TestCUDAProducerOverheadEW::TestCUDAProducerOverheadEW(const edm::ParameterSet& iConfig):
  ...
  lockMutex_{iConfig.getParameter<bool>("lockMutex")}
{}
...
void TestCUDAProducerOverheadEW::acquire(edm::StreamID id, const edm::Event& iEvent, const edm::EventSetup& iSetup, edm::WaitingTaskWithArenaHolder) const {
  if(lockMutex_)
