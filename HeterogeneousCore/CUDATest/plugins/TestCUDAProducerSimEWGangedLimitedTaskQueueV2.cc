...
class TestCUDAProducerSimEWGangedLimitedTaskQueueV2: public edm::stream::EDProducer<edm::ExternalWork, edm::GlobalCache<Ganger>> {
public:
  explicit TestCUDAProducerSimEWGangedLimitedTaskQueueV2(const edm::ParameterSet& iConfig, const Ganger* ganger);
...
TestCUDAProducerSimEWGangedLimitedTaskQueueV2::TestCUDAProducerSimEWGangedLimitedTaskQueueV2(const edm::ParameterSet& iConfig, const Ganger* ganger) {
...
void TestCUDAProducerSimEWGangedLimitedTaskQueueV2::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
void TestCUDAProducerSimEWGangedLimitedTaskQueueV2::acquire(const edm::Event& iEvent, const edm::EventSetup& iSetup, edm::WaitingTaskWithArenaHolder h) {
  //edm::LogWarning("foo") << "TestCUDAProducerSimEWGangedLimitedTaskQueueV2::acquire() begin";
  ...
  //edm::LogWarning("foo") << "TestCUDAProducerSimEWGangedLimitedTaskQueueV2::acquire() end";
}

void TestCUDAProducerSimEWGangedLimitedTaskQueueV2::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  //edm::LogWarning("foo") << "TestCUDAProducerSimEWGangedLimitedTaskQueueV2::produce()";
...
DEFINE_FWK_MODULE(TestCUDAProducerSimEWGangedLimitedTaskQueueV2);
