...
class TestCUDAProducerSimEWGangedLimitedTaskQueueV2
...
TestCUDAProducerSimEWGangedLimitedTaskQueueV2::TestCUDAProducerSimEWGangedLimitedTaskQueueV2(
...
void TestCUDAProducerSimEWGangedLimitedTaskQueueV2::acquire(const edm::Event& iEvent,
