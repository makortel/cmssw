      ...
      if (queueTask) {
        taskQueue->push([this, ctxState]() mutable {
          ...
          try {
            ...
            if (not opsPtr) {
              throw cms::Exception("LogicError") << "Tried to get acquire operations in Ganger::enqueue, but got none. "
                                                    "Likely there is an internal logic error";
            }
...
class TestCUDAProducerSimEWGangedLimitedTaskQueueV4
...
TestCUDAProducerSimEWGangedLimitedTaskQueueV4::TestCUDAProducerSimEWGangedLimitedTaskQueueV4(
...
void TestCUDAProducerSimEWGangedLimitedTaskQueueV4::acquire(const edm::Event& iEvent,
