...
class testHeterogeneousProduct: public CppUnit::TestFixture {
  ...
  CPPUNIT_TEST(testSwapGPUMock);
  CPPUNIT_TEST(testSwapGPUCuda);
...
public:
  ...
  void testGPUCuda();
  void testGPUAll();
  void testSwapGPUMock();
  void testSwapGPUCuda();
  void testProduct();
};
...
void testHeterogeneousProduct::testSwapGPUMock() {
  // Data initially on GPUMock
...
void testHeterogeneousProduct::testSwapGPUCuda() {
  // Data initially on GPUCuda
  using Type = HeterogeneousProductImpl<heterogeneous::CPUProduct<int>,
                                        heterogeneous::GPUMockProduct<int>,
                                        heterogeneous::GPUCudaProduct<int>
...
void testHeterogeneousProduct::testProduct() {
  ...
  prod1.swap(prod2);
  CPPUNIT_ASSERT(prod2.get<Type1>().getProduct<HeterogeneousDevice::kCPU>() == 5);
  CPPUNIT_ASSERT_THROW(prod2.get<Type2>(), cms::Exception);
