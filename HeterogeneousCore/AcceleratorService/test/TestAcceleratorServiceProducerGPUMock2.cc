...
private:
  ...
  void produceGPUMock(edm::Event& iEvent, const edm::EventSetup& iSetup) override;
};
...
void TestAcceleratorServiceProducerGPUMock2::produceGPUMock(edm::Event& iEvent, const edm::EventSetup& iSetup) {
