...
/**
 * Error handling for CUDA driver API
 *
 * The Error codes and the corresponding definitions
 * are taken from the CUDA samples, namely
 * common/inc/drvapi_error_string.h
 * Please refer to the CUDA samples documentation for more information.
 */
