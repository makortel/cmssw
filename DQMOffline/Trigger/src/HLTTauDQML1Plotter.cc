...
HLTTauDQML1Plotter::HLTTauDQML1Plotter(const edm::ParameterSet& ps, int phibins, double maxpt, double maxhighpt, bool ref, double dr, const std::string& dqmBaseFolder):
