...
# Remove castorRawData until castor is included in the geometry(?)
eras.phase1Pixel.toReplaceWith(DigiToRaw, DigiToRaw.copyAndExclude([siPixelRawData, castorRawData])) # FIXME
