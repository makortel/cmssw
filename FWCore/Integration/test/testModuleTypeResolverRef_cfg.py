...
parser.add_argument("--streamer", action="store_true", help="Use streamer file format instead of ROOT file format")
...
fname = "moduletyperesolver_ref_{}".format(process.source.firstEvent.value())
if args.streamer:
