...
using IsolationRegionAroundL3MuonEDProducer = TrackingRegionEDProducerT<IsolationRegionAroundL3Muon>;
DEFINE_FWK_MODULE(IsolationRegionAroundL3MuonEDProducer);
