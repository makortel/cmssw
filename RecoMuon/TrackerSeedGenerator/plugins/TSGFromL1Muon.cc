...
TSGFromL1Muon::TSGFromL1Muon(const edm::ParameterSet& cfg)
  : theConfig(cfg),theRegionProducer(0),theFitter(0),theMerger(0)
{
  ...
  theHitGenerator.reset(OrderedHitsGeneratorFactory::get()->create( hitsfactoryName, hitsfactoryPSet, iC));
}
