...
trackingPhase1PU70.toModify(convLayerPairs,
    ...
    MTIB = dict(clusterChargeCut = dict(refToPSet_ = "SiStripClusterChargeCutNone")),
    ...
    TOB = dict(clusterChargeCut = dict(refToPSet_ = "SiStripClusterChargeCutNone")),
    MTOB3 = dict(clusterChargeCut = dict(refToPSet_ = "SiStripClusterChargeCutNone")),
)
