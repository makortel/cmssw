...
# lowPtQuadStepSeeds.ClusterCheckPSet.doClusterCheck = cms.bool(False) # MK do we need this?
...
lowPtQuadStepChi2Est = RecoTracker.MeasurementDet.Chi2ChargeMeasurementEstimatorESProducer_cfi.Chi2ChargeMeasurementEstimator.clone(
