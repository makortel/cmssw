...
_lowPtTripletStepChi2EstBase = _Chi2ChargeMeasurementEstimator.clone(
    ComponentName = cms.string('lowPtTripletStepChi2Est'),
    nSigma = cms.double(3.0),
    MaxChi2 = cms.double(9.0),
)
lowPtTripletStepChi2Est = _lowPtTripletStepChi2EstBase.clone(
    clusterChargeCut = cms.PSet(refToPSet_ = cms.string('SiStripClusterChargeCutTiny')),
)
eras.trackingPhase1.toReplaceWith(lowPtTripletStepChi2Est, _lowPtTripletStepChi2EstBase.clone(
...
LowPtTripletStep = cms.Sequence(lowPtTripletStepClusters*
                                ...
                                lowPtTripletStep)
eras.trackingPhase1.toReplaceWith(LowPtTripletStep, cms.Sequence(
    LowPtTripletStep.copyAndExclude([lowPtTripletStep]) +
