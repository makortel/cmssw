...
import RecoPixelVertexing.PixelLowPtUtilities.LowPtClusterShapeSeedComparitor_cff
lowPtTripletStepSeeds.OrderedHitsFactoryPSet.GeneratorPSet.SeedComparitorPSet = RecoPixelVertexing.PixelLowPtUtilities.LowPtClusterShapeSeedComparitor_cff.LowPtClusterShapeSeedComparitor
...
from RecoPixelVertexing.PixelLowPtUtilities.ClusterShapeTrajectoryFilter_cff import *
# Composite filter
lowPtTripletStepTrajectoryFilter = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CompositeTrajectoryFilter_block.clone(
    filters = [lowPtTripletStepStandardTrajectoryFilter,
               ClusterShapeTrajectoryFilter_block]
    )
...
lowPtTripletStepTrajectoryBuilder = RecoTracker.CkfPattern.GroupedCkfTrajectoryBuilder_cfi.GroupedCkfTrajectoryBuilder.clone(
    ...
    trajectoryFilter = lowPtTripletStepTrajectoryFilter,
    maxCand = 4,
