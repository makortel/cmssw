...
def _modifyForPhase1(process):
    ...
    lowPtTripletStepChi2Est.clusterChargeCut = RecoTracker.MeasurementDet.Chi2ChargeMeasurementEstimatorESProducer_cfi.Chi2ChargeMeasurementEstimator.clusterChargeCut.value()
