...
eras.trackingPhase2PU140.toModify(lowPtQuadStepTrackingRegions, RegionPSet = dict(ptMin = 0.35))
...
eras.trackingPhase1PU70.toModify(lowPtQuadStepHitTriplets, maxElement=0, produceIntermediateHitTriplets=False, produceSeedingHitSets=True)
eras.trackingPhase1PU70.toReplaceWith(lowPtQuadStepHitQuadruplets, _lowPtQuadStepHitQuadrupletsMerging)
eras.trackingPhase2PU140.toModify(lowPtQuadStepHitTriplets, maxElement=0, produceIntermediateHitTriplets=False, produceSeedingHitSets=True)
eras.trackingPhase2PU140.toReplaceWith(lowPtQuadStepHitQuadruplets, _lowPtQuadStepHitQuadrupletsMerging)
