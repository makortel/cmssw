...
eras.trackingLowPU.toModify(mixedTripletStepTrackingRegionsA, RegionPSet = dict(originHalfLength = 10.0))
eras.trackingPhase1PU70.toModify(mixedTripletStepTrackingRegionsA, RegionPSet = dict(ptMin = 0.7))
...
eras.trackingPhase1PU70.toModify(mixedTripletStepSeedsA,
    SeedComparitorPSet = dict(ClusterShapeHitFilterName = 'ClusterShapeHitFilter'),
)
...
eras.trackingPhase1PU70.toModify(mixedTripletStepTrackingRegionsB, RegionPSet = dict(
    ptMin = 0.5,
    originHalfLength = 15.0,
    originRadius = 1.0
))
