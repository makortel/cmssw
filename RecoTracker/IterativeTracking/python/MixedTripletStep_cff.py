...
_mixedTripletStepTrajectoryFilterBase = _CkfBaseTrajectoryFilter_block.clone(
#    maxLostHits = 0,
...
_mixedTripletStepChi2Est = _Chi2ChargeMeasurementEstimator.clone(
    ComponentName = cms.string('mixedTripletStepChi2Est'),
    nSigma = cms.double(3.0),
    MaxChi2 = cms.double(16.0),
)
mixedTripletStepChi2Est = _mixedTripletStepChi2Est.clone(
    clusterChargeCut = cms.PSet(refToPSet_ = cms.string('SiStripClusterChargeCutTight'))
)
eras.trackingPhase1.toReplaceWith(mixedTripletStepChi2Est, _mixedTripletStepChi2Est.clone(
    clusterChargeCut = dict(refToPSet_ = 'SiStripClusterChargeCutNone'),
))
...
MixedTripletStep = cms.Sequence(chargeCut2069Clusters*mixedTripletStepClusters*
                                ...
                                mixedTripletStep)
eras.trackingPhase1.toReplaceWith(MixedTripletStep, cms.Sequence(
