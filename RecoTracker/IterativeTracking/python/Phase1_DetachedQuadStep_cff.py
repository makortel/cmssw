...
# detachedQuadStepSeeds.ClusterCheckPSet.doClusterCheck = cms.bool(False) MK: is this needed
...
detachedQuadStepChi2Est = RecoTracker.MeasurementDet.Chi2ChargeMeasurementEstimatorESProducer_cfi.Chi2ChargeMeasurementEstimator.clone(
