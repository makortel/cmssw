...
def _modifyForPhase1(process):
    ...
    import TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff
    initialStepTrajectoryFilterBase.maxCCCLostHits = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CkfBaseTrajectoryFilter_block.maxCCCLostHits.value()
    initialStepTrajectoryFilterBase.minGoodStripCharge = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CkfBaseTrajectoryFilter_block.minGoodStripCharge.clone()
    import RecoTracker.MeasurementDet.Chi2ChargeMeasurementEstimator_cfi
    initialStepChi2Est.clusterChargeCut = RecoTracker.MeasurementDet.Chi2ChargeMeasurementEstimator_cfi.Chi2ChargeMeasurementEstimator.clusterChargeCut.value()
    initialStepChi2Est.pTChargeCutThreshold = RecoTracker.MeasurementDet.Chi2ChargeMeasurementEstimator_cfi.Chi2ChargeMeasurementEstimator.pTChargeCutThreshold.value()
