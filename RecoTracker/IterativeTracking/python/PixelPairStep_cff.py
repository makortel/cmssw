...
_pixelPairStepTrajectoryFilterBase = _CkfBaseTrajectoryFilter_block.clone(
...
_pixelPairStepChi2EstBase = _Chi2ChargeMeasurementEstimator.clone(
    ComponentName = cms.string('pixelPairStepChi2Est'),
    nSigma = cms.double(3.0),
    MaxChi2 = cms.double(9.0),
)
pixelPairStepChi2Est = _pixelPairStepChi2EstBase.clone(
    clusterChargeCut = cms.PSet(refToPSet_ = cms.string('SiStripClusterChargeCutTiny')),
    pTChargeCutThreshold = cms.double(15.)
)
eras.trackingPhase1.toReplaceWith(pixelPairStepChi2Est, _pixelPairStepChi2EstBase.clone(
    MaxChi2 = 16.0,
...
PixelPairStep = cms.Sequence(pixelPairStepClusters*
                         ...
                         pixelPairStepTracks*
                         pixelPairStep)
eras.trackingPhase1.toReplaceWith(PixelPairStep, cms.Sequence(
    PixelPairStep.copyAndExclude([pixelPairStep]) +
