...
#lar    largeD0step3CkfTrajectoryFilter.maxConsecLostHits = 2
...
largeD0step3CkfInOutTrajectoryFilter = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CkfBaseTrajectoryFilter_block.clone()
largeD0step3CkfInOutTrajectoryFilter.maxLostHits = 0
#lar    largeD0step3CkfInOutTrajectoryFilter.maxConsecLostHits = 2
...
largeD0step3CkfTrajectoryBuilder = RecoTracker.CkfPattern.GroupedCkfTrajectoryBuilder_cfi.GroupedCkfTrajectoryBuilder.clone(
    ...
    trajectoryFilter = largeD0step3CkfTrajectoryFilter,
    inOutTrajectoryFilter = largeD0step3CkfInOutTrajectoryFilter,
