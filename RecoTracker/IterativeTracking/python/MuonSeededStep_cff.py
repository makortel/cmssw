...
muonSeededMeasurementEstimatorForInOut = _Chi2MeasurementEstimator.clone(
...
eras.phase1Pixel.toModify(muonSeededMeasurementEstimatorForInOut, MaxChi2 = 400,
                          MaxSagitta = _Chi2MeasurementEstimator.MaxSagitta.value())
muonSeededMeasurementEstimatorForOutIn = _Chi2MeasurementEstimator.clone(
...
eras.phase1Pixel.toModify(muonSeededMeasurementEstimatorForOutIn, MaxSagitta = _Chi2MeasurementEstimator.MaxSagitta.value())
...
eras.phase1Pixel.toModify(muonSeededStepExtraInOut, lambda x: x.replace(muonSeededTracksInOutClassifier, muonSeededTracksInOutSelector))
muonSeededStepExtra = cms.Sequence(
    muonSeededStepExtraInOut +
    muonSeededTracksOutInClassifier
)
eras.phase1Pixel.toModify(muonSeededStepExtra, lambda x: x.replace(muonSeededTracksOutInClassifier, muonSeededTracksOutInSelector))
