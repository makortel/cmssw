...
def _modifyForPhase1(process):
    ...
    muonSeededMeasurementEstimatorForInOut.MaxSagitta = TrackingTools.KalmanUpdators.Chi2MeasurementEstimator_cfi.Chi2MeasurementEstimator.MaxSagitta.value()
    muonSeededMeasurementEstimatorForOutIn.MaxSagitta = TrackingTools.KalmanUpdators.Chi2MeasurementEstimator_cfi.Chi2MeasurementEstimator.MaxSagitta.value()
