...
largeD0step5CkfInOutTrajectoryFilter = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CkfBaseTrajectoryFilter_block.clone()
largeD0step5CkfInOutTrajectoryFilter.maxLostHits = 0
#lar    largeD0step5CkfInOutTrajectoryFilter.maxConsecLostHits = 2
...
largeD0step5CkfTrajectoryBuilder = RecoTracker.CkfPattern.GroupedCkfTrajectoryBuilder_cfi.GroupedCkfTrajectoryBuilder.clone(
    ...
    trajectoryFilter = largeD0step5CkfTrajectoryFilter,
