...
largeD0step4CkfInOutTrajectoryFilter = TrackingTools.TrajectoryFiltering.TrajectoryFilter_cff.CkfBaseTrajectoryFilter_block.clone()
...
largeD0step4CkfTrajectoryBuilder = RecoTracker.CkfPattern.GroupedCkfTrajectoryBuilder_cfi.GroupedCkfTrajectoryBuilder.clone(
    ...
    trajectoryFilter = largeD0step4CkfTrajectoryFilter,
    inOutTrajectoryFilter = largeD0step4CkfInOutTrajectoryFilter,
