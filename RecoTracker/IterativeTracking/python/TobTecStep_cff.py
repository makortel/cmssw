...
_tobTecStepTrajectoryFilterBase = _CkfBaseTrajectoryFilter_block.clone(
    maxLostHits = 0,
...
_tobTecStepChi2EstBase = _Chi2ChargeMeasurementEstimator.clone(
    ComponentName = cms.string('tobTecStepChi2Est'),
    nSigma = cms.double(3.0),
    MaxChi2 = cms.double(16.0),
)
tobTecStepChi2Est = _tobTecStepChi2EstBase.clone(
    clusterChargeCut = cms.PSet(refToPSet_ = cms.string('SiStripClusterChargeCutTight'))
)
eras.trackingPhase1.toReplaceWith(tobTecStepChi2Est, _tobTecStepChi2EstBase.clone(
    MaxChi2 = 9.0,
